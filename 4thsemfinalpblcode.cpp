...
/*int main()
{
    ...
    while(1)
    {
        cout << "1.Range Kutta 2nd order\n"
             << "2.Range Kutta 4th Order\n"
             << "3.Taylor Sine Series Method\n"
             << "4.Taylor Cosine Series Method\n";
        ...
        switch(choice)
        {
            case 1: c.rangeKUTTAtwo();
                    break;

            case 2: c.rangeKUTTAfour();
                    break;

            case 3: c.taylorSINEseries();
                    break;

            case 4: c.taylorCOSINEseries();
                    break;
        }
    }
    return 0;
